    ...
    <div>
      ...
      <section className='appoinment-banner flex my-24'>
        <div className='flex-1 mt-[-120px] hidden lg:block'>
          <img src={doctor} className="rounded-lg shadow-2xl p-0 m-0" />
        </div>
        <div className='flex-1 px-12'>
          <h1 className="text-2xl font-bold text-primary py-6">Appoinment</h1>
          <h3 className='text-3xl py-3 text-white'>Make an appointment Today</h3>
          <p className="py-6 text-white">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
          <button className="btn btn-primary my-4 text-white bg-gradient-to-r from-secondary to-primary">Get Started</button>
        </div>
      </section>
    </div>
  );
